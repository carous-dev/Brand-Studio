...
import NcrCookieBanner from './NcrCookieBanner'
 ...
 */
export function NcrShell({ children }: { children: ReactNode }) {
  ...
  if (isSpecialArea) {
    return (
      <main id="content" role="main" className="ncr-main main-dashboard">
        {children}
      </main>
    )
  }
  ...
  return (
    <GarageProvider brandSlug={brand?.slug || 'default'}>
      <a href="#content" className="ncr-skip-link">Skip to content</a>
      <AnimateOnScroll />
      <MotionFX />
      <ScrollProgress />
      <Header />
      <main id="content" role="main" className="ncr-main">
        {children}
      </main>
      <Footer />
