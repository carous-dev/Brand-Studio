 ...
 * loopback / unknown hosts. Used by server-component data fetchers so
 * the inventory / featured / recently-sold endpoints resolve to the
 * brand-specific inventory uploaded via `/update/<slug>`.
 */
