...
// Queensbury baseline page; Mode B (clone-and-edit) ports inherit this.
...
function VehicleNotFoundTemplate({
  ...
  const QUEENSBURY_PHONE_DISPLAY = __contact.phoneDisplay;
  const QUEENSBURY_PHONE_TEL = __contact.phoneTel;
  const QUEENSBURY_WHATSAPP_URL = __contact.whatsappUrl;
      ...
      <section className={styles.notFoundHero} aria-labelledby="vehicle-not-found-title">
        <div className={styles.notFoundInner}>
          ...
          <div className={styles.notFoundLinks} aria-label="Helpful shortcuts">
            ...
            <a className={styles.notFoundInlineLink} href={`tel:${QUEENSBURY_PHONE_TEL}`}>
              Call {QUEENSBURY_PHONE_DISPLAY}
            </a>
            <span className={styles.notFoundSeparator} aria-hidden="true">
              ·
            </span>
            <a className={styles.notFoundInlineLink} href={QUEENSBURY_WHATSAPP_URL} target="_blank" rel="noreferrer">
              WhatsApp
            </a>
          </div>
        </div>
...
export function QueensburyVehicleDetailPage() {
  const __brand = useBrand();
  const __contact = getBrandContactInfo(__brand);
  const QUEENSBURY_PHONE_DISPLAY = __contact.phoneDisplay;
  const QUEENSBURY_PHONE_TEL = __contact.phoneTel;
              ...
              <div className={styles.stickyCard}>
                ...
                <div className={styles.sideCard}>
                  ...
                  <div className={styles.contactStack}>
                    {QUEENSBURY_PHONE_TEL ? (
                      <a href={`tel:${QUEENSBURY_PHONE_TEL}`}>
                        <span className={styles.sideStatIcon}><Phone size={16} strokeWidth={2} /></span>
                        {QUEENSBURY_PHONE_DISPLAY || 'Call us'}
                      </a>
                    ) : null}
                    {__contact.email ? (
...
export default QueensburyVehicleDetailPage
