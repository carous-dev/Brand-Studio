    ...
    >
      <defs>
        <linearGradient id="hb-base" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="color-mix(in srgb, var(--color-primary) 80%, var(--kain-black))" stopOpacity="1" />
        </linearGradient>
      ...
      <linearGradient id="hb-bottom-fade" x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="var(--kain-black)" stopOpacity="0" />
        <stop offset="100%" stopColor="var(--kain-black)" stopOpacity="0.32" />
      </linearGradient>
      <rect width="1440" height="600" fill="url(#hb-bottom-fade)" />

      {/* uniform darken pass for legibility */}
      <rect width="1440" height="600" fill="var(--kain-black)" opacity="0.22" />
    </svg>
  )
}
