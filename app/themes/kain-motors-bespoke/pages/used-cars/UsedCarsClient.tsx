                ...
                {showSkeleton ? (
                  ...
                  <>
                    <div className={styles.toolbarTopRow}>
                      <span className={styles.toolbarCount} aria-live="polite">
                        <strong>{resultsCount}</strong> vehicles available
                      </span>
                      <button
                        type="button"
                ...
                <div className={styles.results}>
                  ...
                  <div className={styles.cardGrid}>
                    ...
                    {showSkeleton
                      ...
                      : visibleVehicles.map((vehicle, vehicleIdx) => {
                      const savedVehicle = toSavedVehicle(vehicle)
                      const wishlisted = isWishlisted(vehicle.id)
                      const compared = isCompared(vehicle.id)
                      const detailHref = buildVehiclePermalink({ slug: vehicle.slug || toSlug(vehicle.title), reg: vehicle.reg }, '/used-cars')
                      const cardKey = `${vehicle.reg || vehicle.id || 'v'}-${vehicleIdx}`
                      return (
                        <article key={cardKey} className={styles.card}>
                          <Link href={detailHref} className={styles.cardLink} aria-label={vehicle.title}>
                            <span className={styles.cardLinkLabel}>View {vehicle.title}</span>
                          </Link>
                          <div
                          ...
                          <div className={styles.cardQuickActions}>
                            <button
                              ...
                              onClick={(e) => { e.preventDefault(); e.stopPropagation(); toggleCompare(savedVehicle) }}
                            >
                            ...
                            <button
                              ...
                              onClick={(e) => { e.preventDefault(); e.stopPropagation(); toggleWishlist(savedVehicle) }}
                            >
