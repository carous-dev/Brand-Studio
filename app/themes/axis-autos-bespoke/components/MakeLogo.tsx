 ...
 * tints with `currentColor` (contrast-safe on any brand palette — the axis
 * BrowseByMake chip sets that to var(--brand-primary)). Makes without an icon
 * fall back to a bare monogram glyph once the probe 404s. Mirrors fbm-motors.
 */
