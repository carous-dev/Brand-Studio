    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <h1 className={styles.heroTitle}>{area ? `Used cars in ${area}` : 'Used cars for sale'}</h1>
          <p className={styles.heroLead}>
            Browse carefully presented used cars from {brandName} — finance, part-exchange and
