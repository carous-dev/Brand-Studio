...
// Ele baseline page; Mode B (clone-and-edit) ports inherit this.
...
function VehicleNotFoundTemplate({
  ...
  const ELE_PHONE_DISPLAY = __contact.phoneDisplay || '+44 7738 906707';
  const ELE_PHONE_TEL = __contact.phoneTel || '+447738906707';
  const ELE_WHATSAPP_URL = __contact.whatsappUrl || 'https://wa.me/447738906707';
      ...
      <section className={styles.notFoundHero} aria-labelledby="vehicle-not-found-title">
        <div className={styles.notFoundInner}>
          ...
          <div className={styles.notFoundLinks} aria-label="Helpful shortcuts">
            ...
            <a className={styles.notFoundInlineLink} href={`tel:${ELE_PHONE_TEL}`}>
              Call {ELE_PHONE_DISPLAY}
            </a>
            <span className={styles.notFoundSeparator} aria-hidden="true">
              ·
            </span>
            <a className={styles.notFoundInlineLink} href={ELE_WHATSAPP_URL} target="_blank" rel="noreferrer">
              WhatsApp
            </a>
          </div>
        </div>
...
export function EleVehicleDetailPage() {
  const __brand = useBrand();
  const __contact = getBrandContactInfo(__brand);
  const ELE_PHONE_DISPLAY = __contact.phoneDisplay || '+44 7738 906707';
  const ELE_PHONE_TEL = __contact.phoneTel || '+447738906707';
