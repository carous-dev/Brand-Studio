...
/**
 * Site-wide smooth scrolling for the cnhcars-clone theme. Renders no DOM —
 * `<ReactLenis root />` attaches Lenis to the document root. Mounted once in
 * the theme shell, so it only activates when cnhcars-clone is the active
 * brand. Mirrors the classic-dealer / fbm-motors / axis-autos SmoothScroll.
 */
