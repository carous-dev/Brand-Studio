...
// Buy4lessuk baseline page; Mode B (clone-and-edit) ports inherit this.
...
function VehicleNotFoundTemplate({
  ...
  const BUY4LESSUK_PHONE_DISPLAY = __contact.phoneDisplay;
  const BUY4LESSUK_PHONE_TEL = __contact.phoneTel;
  const BUY4LESSUK_WHATSAPP_URL = __contact.whatsappUrl;
      ...
      <section className={styles.notFoundHero} aria-labelledby="vehicle-not-found-title">
        <div className={styles.notFoundInner}>
          ...
          <div className={styles.notFoundLinks} aria-label="Helpful shortcuts">
            ...
            <a className={styles.notFoundInlineLink} href={`tel:${BUY4LESSUK_PHONE_TEL}`}>
              Call {BUY4LESSUK_PHONE_DISPLAY}
            </a>
            <span className={styles.notFoundSeparator} aria-hidden="true">
              ·
            </span>
            <a className={styles.notFoundInlineLink} href={BUY4LESSUK_WHATSAPP_URL} target="_blank" rel="noreferrer">
              WhatsApp
            </a>
          </div>
        </div>
...
export function Buy4lessukVehicleDetailPage() {
  const __brand = useBrand();
  const __contact = getBrandContactInfo(__brand);
  const BUY4LESSUK_PHONE_DISPLAY = __contact.phoneDisplay;
  const BUY4LESSUK_PHONE_TEL = __contact.phoneTel;
              ...
              <div className={styles.stickyCard}>
                ...
                <div className={styles.sideCard}>
                  ...
                  <div className={styles.contactStack}>
                    {BUY4LESSUK_PHONE_TEL ? (
                      <a href={`tel:${BUY4LESSUK_PHONE_TEL}`}>
                        <span className={styles.sideStatIcon}><Phone size={16} strokeWidth={2} /></span>
                        {BUY4LESSUK_PHONE_DISPLAY || 'Call us'}
                      </a>
                    ) : null}
                    {__contact.email ? (
...
export default Buy4lessukVehicleDetailPage
