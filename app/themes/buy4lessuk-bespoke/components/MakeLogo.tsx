...
/**
 * Marque logo from the simple-icons CDN. Rendered as a plain <img> (masks of
 * cross-origin SVGs don't paint reliably), softened via opacity so the
 * monochrome glyphs read as a quiet grayscale logo strip. Makes without an
 * icon fall back to a monogram badge when the request 404s.
 */
