...
/**
 * Site-wide smooth scrolling for the buy4lessuk-bespoke theme. Renders no DOM —
 * `<ReactLenis root />` attaches Lenis to the document root. Mounted once in the
 * theme Shell, so it only activates when buy4less is the active brand. Mirrors
 * the fbm-motors / axis-autos SmoothScroll (and the @carous/smooth-scroll
 * package).
 */
