    ...
    >
      <defs>
        ...
        <radialGradient id="hb-glow-tr" cx="82%" cy="-10%" r="55%">
          <stop offset="0%" stopColor="var(--color-text-invert)" stopOpacity="0.5" />
        ...
        <radialGradient id="hb-orb-1" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="var(--color-text-invert)" stopOpacity="0.7" />
          <stop offset="55%" stopColor="var(--color-text-invert)" stopOpacity="0.18" />
          <stop offset="100%" stopColor="var(--color-text-invert)" stopOpacity="0" />
        </radialGradient>

        <linearGradient id="hb-poly-1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--color-text-invert)" stopOpacity="0.18" />
          <stop offset="100%" stopColor="var(--color-text-invert)" stopOpacity="0" />
        </linearGradient>
        ...
        <linearGradient id="hb-line" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="var(--color-text-invert)" stopOpacity="0" />
          <stop offset="50%" stopColor="var(--color-text-invert)" stopOpacity="0.55" />
          <stop offset="100%" stopColor="var(--color-text-invert)" stopOpacity="0" />
        </linearGradient>
      ...
      <circle cx="400" cy="120" r="3" fill="var(--color-text-invert)" opacity="0.7" />
      <circle cx="1320" cy="540" r="3" fill="var(--color-text-invert)" opacity="0.6" />
      <circle cx="980" cy="380" r="2" fill="var(--color-text-invert)" opacity="0.5" />
      <rect x="540" y="440" width="6" height="6" fill="var(--color-text-invert)" opacity="0.45" transform="rotate(45 543 443)" />
      <rect x="1080" y="240" width="5" height="5" fill="var(--color-text-invert)" opacity="0.5" transform="rotate(45 1082.5 242.5)" />
