...
// AutoTrader wordmark uses its own fixed third-party brand identity (navy + red)
// and must NOT follow the dealer palette — held as named constants so the logo
// renders in AutoTrader's real colours regardless of the active theme.
