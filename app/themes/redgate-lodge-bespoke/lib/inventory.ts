...
export function normalizeInventoryItem(item: any): InventoryVehicle | null {
  ...
  // Generic "no photo" placeholder for a vehicle with no feed image — inventory
  // fallback, not a brand-overridable theme slot.
  const fallbackImage = '/images/image.png' // image-static-ok
