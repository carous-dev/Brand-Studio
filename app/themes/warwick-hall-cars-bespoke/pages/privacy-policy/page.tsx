 ...
 * Standard UK GDPR privacy policy — pull from brand.legal if available.
 */
export function WarwickPrivacyPolicyPage({ brand }: ThemePageProps) {
...
export default WarwickPrivacyPolicyPage
