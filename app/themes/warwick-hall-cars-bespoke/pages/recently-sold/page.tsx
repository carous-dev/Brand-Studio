...
export function WarwickRecentlySoldPage({ initialInventory, brand }: ThemePageProps) {
  const items = Array.isArray(initialInventory) ? initialInventory : []
  return (
    <section className="warwick-section">
      <div className="sps-section-container">
        ...
        <div style={{ textAlign: 'center', marginTop: 32 }}>
          <Link href="/used-cars" className="warwick-cta-link">
            See current stock
          </Link>
        </div>
      </div>
...
export default WarwickRecentlySoldPage
