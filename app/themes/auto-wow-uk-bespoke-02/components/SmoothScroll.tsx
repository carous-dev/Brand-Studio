...
/**
 * Site-wide smooth scrolling for the Auto Wow theme. Renders no DOM —
 * `<ReactLenis root />` attaches Lenis to the document root. Mounted once in
 * the theme shell, so it only activates when Auto Wow is the active brand.
 * Mirrors the cnhcars-clone / classic-dealer / fbm-motors / axis-autos
 * SmoothScroll.
 */
