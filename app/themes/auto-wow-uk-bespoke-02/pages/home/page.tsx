...
import HorizontalStockTicker from '../../components/HorizontalStockTicker'
...
export async function AutoHomePage(_props: ThemePageProps) {
  const { featured, meta } = await fetchHomeData()

  return (
    <>
      <Hero
        featuredCount={meta.total}
        availableMakes={meta.makes}
        availableBodies={meta.bodies}
      />
      <HorizontalStockTicker stockCount={meta.total} sampleMakes={meta.makes} />
