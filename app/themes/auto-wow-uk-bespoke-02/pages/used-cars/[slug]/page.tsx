...
export default function AutoVehicleDetailPage() {
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={`auto-section ${styles.content}`}>
        <div className={styles.contentInner}>
          ...
          <aside className={styles.sidebar} aria-label="Price and enquiry">
            <div className={styles.priceCard}>
              ...
              <button
                type="button"
                className={`auto-btn auto-btn--primary mfx-shimmer ${styles.enquireBtn}`}
      ...
      <div className={styles.stickyMobileBar}>
        ...
        <button
          type="button"
          className={`auto-btn auto-btn--primary ${styles.stickyEnquire}`}
          onClick={enquiry.open}
        >
          Enquire
      ...
      {/* SIMILAR VEHICLES */}
      {similar.length > 0 ? (
        <section className={`auto-section auto-section--card ${styles.similar}`}>
          <div className={styles.similarInner}>
            <header className={styles.similarHeader}>
              ...
              <Link href={`/used-cars?make=${encodeURIComponent(vehicle.make)}`} className="auto-cta-link">
      ...
      {availableMakes.length > 0 ? (
        <section className={`auto-section ${styles.makesSeo}`}>
