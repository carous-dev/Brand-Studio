    ...
    <form onSubmit={onSubmit} className={styles.form} noValidate>
      ...
      <div className={styles.row}>
        <label className={styles.field}>
          ...
          <input
            ...
            aria-required="true"
            placeholder="ABC 123"
            aria-invalid={form.errors.reg ? 'true' : undefined}
        ...
        <label className={styles.field}>
          ...
          <input
            ...
            aria-invalid={form.errors.mileage ? 'true' : undefined}
      ...
      <div className={styles.row}>
        <label className={styles.field}>
          ...
          <input
            ...
            required
            aria-required="true"
            aria-invalid={form.errors.buyer_name ? 'true' : undefined}
            {...form.getFieldProps('buyer_name')}
          />
        ...
        <label className={styles.field}>
          ...
          <input
            ...
            required
            aria-required="true"
            aria-invalid={form.errors.buyer_phone ? 'true' : undefined}
            {...form.getFieldProps('buyer_phone')}
          />
      ...
      <label className={styles.field}>
        ...
        <input
          ...
          required
          aria-required="true"
          aria-invalid={form.errors.buyer_email ? 'true' : undefined}
          {...form.getFieldProps('buyer_email')}
        />
      ...
      <label className={styles.field}>
        ...
        <textarea
          rows={3}
          placeholder="Any service history, recent work, or details we should know"
      ...
      <label className={styles.checkbox}>
        <input
          ...
          onChange={(e) => form.setFieldValue('consent', e.target.checked as any)}
        />
      ...
      <button
        type="submit"
        className={`auto-btn auto-btn--primary mfx-shimmer ${styles.submit}`}
