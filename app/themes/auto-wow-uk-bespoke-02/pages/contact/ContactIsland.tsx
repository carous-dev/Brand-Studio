...
export default function ContactIsland() {
  ...
  const form = useLeadsForm<FormValues>({
    ...
    fieldConfig: {
      ...
      consent: {
        required: true,
        validate: (value) => (value ? null : 'Please tick to confirm.'),
      },
    },
  })
  ...
  if (form.status === 'success') {
    return (
      <div className={styles.success} role="status" aria-live="polite">
        ...
        <p>
          Thanks — {brandName} will reply by the end of the working day. If it&apos;s
    ...
    <form onSubmit={onSubmit} className={styles.form} noValidate>
      <header className={styles.header}>
        ...
        <p className={styles.lead}>
          Tell us a bit about what you&apos;re looking for. We&apos;ll reply by email or
          call you back — whichever works.
        </p>
      </header>
