 ...
 *
 * Used by HorizontalStockTicker so the live-stock rail renders real brand
 * glyphs (matching the warwick treatment) instead of a generic Car icon.
 * simple-icons is CC0; trademarks belong to the respective manufacturers and
 * are used nominatively to reference vehicles in stock.
 */
