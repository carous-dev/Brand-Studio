    ...
    >
      <defs>
        <linearGradient id="hb-base" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="color-mix(in srgb, var(--color-primary) 80%, var(--surface-bg-dark))" stopOpacity="1" />
        </linearGradient>

        <radialGradient id="hb-glow-tr" cx="82%" cy="-10%" r="55%">
          <stop offset="0%" stopColor="var(--text-on-dark-strong)" stopOpacity="0.5" />
        ...
        <radialGradient id="hb-orb-1" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="var(--text-on-dark-strong)" stopOpacity="0.7" />
          <stop offset="55%" stopColor="var(--text-on-dark-strong)" stopOpacity="0.18" />
          <stop offset="100%" stopColor="var(--text-on-dark-strong)" stopOpacity="0" />
        </radialGradient>

        <linearGradient id="hb-poly-1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="var(--text-on-dark-strong)" stopOpacity="0.18" />
          <stop offset="100%" stopColor="var(--text-on-dark-strong)" stopOpacity="0" />
        </linearGradient>
        ...
        <linearGradient id="hb-line" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="var(--text-on-dark-strong)" stopOpacity="0" />
          <stop offset="50%" stopColor="var(--text-on-dark-strong)" stopOpacity="0.55" />
          <stop offset="100%" stopColor="var(--text-on-dark-strong)" stopOpacity="0" />
        </linearGradient>
      ...
      <polygon
        ...
        fill="none"
        stroke="var(--text-on-dark-strong)"
        strokeOpacity="0.18"
        strokeWidth="1"
      />
      <polygon
      ...
      <circle cx="400" cy="120" r="3" fill="var(--text-on-dark-strong)" opacity="0.7" />
      <circle cx="1320" cy="540" r="3" fill="var(--text-on-dark-strong)" opacity="0.6" />
      <circle cx="980" cy="380" r="2" fill="var(--text-on-dark-strong)" opacity="0.5" />
      <rect x="540" y="440" width="6" height="6" fill="var(--text-on-dark-strong)" opacity="0.45" transform="rotate(45 543 443)" />
      <rect x="1080" y="240" width="5" height="5" fill="var(--text-on-dark-strong)" opacity="0.5" transform="rotate(45 1082.5 242.5)" />

      {/* bottom edge fade so text above is always legible */}
      <linearGradient id="hb-bottom-fade" x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="var(--surface-bg-dark)" stopOpacity="0" />
        <stop offset="100%" stopColor="var(--surface-bg-dark)" stopOpacity="0.32" />
      </linearGradient>
      <rect width="1440" height="600" fill="url(#hb-bottom-fade)" />

      {/* uniform darken pass for legibility */}
      <rect width="1440" height="600" fill="var(--surface-bg-dark)" opacity="0.22" />
    </svg>
  )
}
