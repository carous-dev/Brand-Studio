...
export async function DualUsedCarsPage({ searchParams }: UsedCarsRuntimeProps) {
  let items: any[] = []
  ...
  try {
    ...
    // Don't constrain by vehicle_type at the API layer — this theme handles
    // BOTH cars and bikes. Client-side filtering by vehicleClass (derived from
    // make / body / declared type) handles the Cars/Bikes/All toggle.
...
export default DualUsedCarsPage
